...
const IaraPage = lazy(() => import("@/pages/iara"));
const GuiaPage = lazy(() => import("@/pages/guia"));
const JuridicoPro = lazy(() => import("@/pages/juridico-pro"));
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/iara" component={IaraPage} />
        <Route path="/guia" component={GuiaPage} />
        <Route path="/juridico-pro" component={JuridicoPro} />
...
function App() {
  const [authState, setAuthState] = useState<"loading" | "login" | "authenticated">("authenticated");

  useEffect(() => {
    // Offline: sempre autenticado — sem servidor necessário
